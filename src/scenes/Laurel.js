...
const characters = {
    ...
    unknown: { name: '???', folder: 'daniel', side: 'left' },
};
...
const dialogues = [
    ...
    { character: 'system', expression: '', text: 'You celebrate with Alice and company into the late hours of the night.', style: 'Italic'},
    ...
    { character: 'kira', expression: 'neutral', text: 'Ah, what a splendid day of triumph... of honor... of integrity... of virtue.', style: 'Normal'},
    ...
    { character: 'kira', expression: 'happy', text: 'The laurel is conferred upon Gamma, as is befitting of their efforts.', style: 'Normal'},
    ...
    { character: 'system', expression: '', text: 'Your face contorts with anger, your voice rising in disbelief.', style: 'Italic'},
    ...
    { character: 'system', expression: '', text: 'The members of gamma present snicker and chuckle under their breath.', style: 'Italic'},
    ...
    { character: 'kira', expression: 'neutral', text: 'Kira cuts her off sharply, his tone laced with menace.', style: 'Italic'},
    { character: 'kira', expression: 'neutral', text: 'Silence, girl.', style: 'Normal'},
    { character: 'kira', expression: 'snarling', text: 'Speak out of turn again, and you’ll join them in execution.', style: 'Normal'},
    ...
    { character: 'system', expression: '', text: 'You are knocked out and dragged from the township.', style: 'Italic'},
    ...
    { character: 'unknown', expression: 'serious', text: 'You hear an unknown voice, as you are awoken by a red man.', style: 'Italic'},
    { character: 'unknown', expression: 'serious', text: 'Hey, wake up!', style: 'Normal'},
    { character: 'unknown', expression: 'serious', text: 'You’re safe, for now.', style: 'Normal'},
    { character: 'unknown', expression: 'serious', text: 'We’ve got to move before they come back.', style: 'Normal'},
    ...
    { character: 'unknown', expression: 'pity', text: 'The unknown man frowns, a hint of sadness in his eyes as he delivers a harsh truth.', style: 'Italic'},
    { character: 'unknown', expression: 'pity', text: 'You can’t go back.', style: 'Normal'},
    { character: 'unknown', expression: 'pity', text: 'You’re dead. They think you died in the pit.', style: 'Normal'},
    { character: 'unknown', expression: 'pity', text: 'If you return, they’ll just execute you again.', style: 'Normal'},
    { character: 'player', expression: '', text: 'You begin to tear up, the weight of your situation sinking in.', style: 'Italic'},
    { character: 'unknown', expression: 'serious', text: 'The unknown man sighs, placing a hand on your shoulder in a gesture of comfort.', style: 'Italic'},
    { character: 'unknown', expression: 'serious', text: 'I know it’s hard, but we’ve got to go.', style: 'Normal'},
    { character: 'unknown', expression: 'serious', text: 'The grays will come back to check the pit, and if they find you missing...', style: 'Normal' }
];
