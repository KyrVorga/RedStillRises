...
export class Institute extends Scene {
    ...
    create() {
        ...
        //     // change zoom factor
        //     const zoomFactor = this.mapManager.zoomFactor + Math.sign(-deltaZ) * 0.1;
        //     const clampedZoomFactor = Phaser.Math.Clamp(zoomFactor, 0.5, 2);

        //     if (clampedZoomFactor < this.mapManager.zoomFactor) {
        //         this.tileSize -= 8;
        //         this.loadSVGs(this.tileSize);
        //     } else if (clampedZoomFactor > this.mapManager.zoomFactor) {
        //         this.tileSize += 8;
        //         this.loadSVGs(this.tileSize);
        //     }
        //     console.log(this.tileSize);

        //     this.mapManager.setTileSize(this.tileSize);
        //     this.mapManager.setZoomFactor(clampedZoomFactor); // Clamp zoom factor between 0.5 and 2
        // });
    ...
    loadSVGs(tileSize) {
        ...
        this.load.svg('grassland', 'assets/tiles/Grassland.svg', { width: tileSize, height: tileSize });
        this.load.svg('fog', 'assets/tiles/Fog.svg', { width: tileSize, height: tileSize });
        this.load.svg('mountain', 'assets/tiles/Mountain.svg', { width: tileSize, height: tileSize });
        this.load.svg('hill', 'assets/tiles/Hill.svg', { width: tileSize, height: tileSize });
        this.load.svg('forest', 'assets/tiles/Forest.svg', { width: tileSize, height: tileSize });
        this.load.svg('greatwood', 'assets/tiles/Greatwood.svg', { width: tileSize, height: tileSize });
        this.load.svg('farmland', 'assets/tiles/Farmland.svg', { width: tileSize, height: tileSize });
        this.load.svg('desert', 'assets/tiles/Desert.svg', { width: tileSize, height: tileSize });
        this.load.svg('swamp', 'assets/tiles/Swamp.svg', { width: tileSize, height: tileSize });
        this.load.svg('tundra', 'assets/tiles/Tundra.svg', { width: tileSize, height: tileSize });
        this.load.svg('castle', 'assets/tiles/Castle.svg', { width: tileSize, height: tileSize });
        this.load.svg('shallow', 'assets/tiles/Shallow.svg', { width: tileSize, height: tileSize });
        this.load.svg('deep', 'assets/tiles/Deep.svg', { width: tileSize, height: tileSize });

        const iconWidth = tileSize * 0.6;
        const iconHeight = tileSize * 0.6;
